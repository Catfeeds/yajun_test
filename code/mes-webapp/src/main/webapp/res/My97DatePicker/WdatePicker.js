 ...
 */
function getReduceDay(targetId,reduceDay,currentDay){
				var minday=$dp.$D(targetId,{d:-reduceDay});
				minday=	minday.y+"-"+(minday.M>9?minday.M:("0"+minday.M))+"-"+(minday.d>9?minday.d:("0"+minday.d));
				return minday>currentDay?minday:currentDay;
}
