...
!function ($) {
    ...
    BootstrapTable.prototype.onPageListChange = function (event) {
        ...
        if(this.options.pageSize>10){
        	this.$tableBody.attr("style","height:580px");
        	this.$tableHeader.attr("style",this.$tableHeader.attr("style")+"background: linear-gradient(#f7f7f7,#f2f2f2, #ececec);");
        }else{
        	this.$tableBody.removeAttr("style");
        }
    };
